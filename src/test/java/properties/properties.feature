...
#   AddressResource         = { street, number, city, postalCode,
#                               country, latitude, longitude }
#   CreatePropertyResource  = { ownerId(string), address(AddressResource),
#                               region(string), district(string) }
#   UpdatePropertyResource  = { address, region, district }
#   PropertyResource        = { id(string), ownerId(string),
